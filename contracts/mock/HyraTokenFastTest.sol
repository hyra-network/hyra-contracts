...
/**
 * @title HyraTokenFastTest
 * @notice Fast test version of HyraToken with SHORT delays for testnet testing
 * @dev ⚠️ DO NOT USE IN PRODUCTION - Only for testnet testing via UI
 * 
    ...
    IHyraToken
{
    ...
    // ============ Core Functions (same as HyraToken) ============
