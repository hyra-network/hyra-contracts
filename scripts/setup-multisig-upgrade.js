...
exports.MultiSigUpgradeSetup = void 0;
...
class MultiSigUpgradeSetup {
     ...
     */
    async deploySecureProxyAdmin(multisigAddress) {
        console.log("Deploying MultiSigProxyAdmin with security configuration...");
        const MultiSigProxyAdmin = await hardhat_1.ethers.getContractFactory("MultiSigProxyAdmin");
     ...
     */
    async createSecureDAOConfig(multisigAddress) {
        const daoConfig = {
            // Token config
            tokenName: "HYRA",
            tokenSymbol: "HYRA",
            ...
            proposalThreshold: hardhat_1.ethers.parseEther("1000000"), // 1M tokens
            ...
            vestingConfig: {
                ...
                amounts: [hardhat_1.ethers.parseEther("2500000000")],
     ...
     */
    async deploySecureDAO(multisigAddress) {
     ...
     */
    generateSecurityReport(deploymentResult) {
        console.log("\n" + "=".repeat(60));
...
exports.MultiSigUpgradeSetup = MultiSigUpgradeSetup;
async function main() {
